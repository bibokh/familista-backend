...
export const CAPABILITIES: ReadonlyArray<Capability> = Object.freeze([
  ...
  { key: 'club.president.resend', module: 'clubs', label: 'Resend the president invitation', status: 'PARTIAL', risk: 'SENSITIVE',
    note: 'Mints a new link and retires the old one. PARTIAL because no mail provider is connected — nothing is emailed, and the link is shown once to whoever resends it.',
