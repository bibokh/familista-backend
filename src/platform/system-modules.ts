...
export const SYSTEM_MODULES: ReadonlyArray<SystemModule> = Object.freeze([
  ...
  { key: 'platform-analytics', label: 'Platform Analytics', group: 'INSIGHT',      readiness: 'LIVE',
    backing: 'AnalyticsEvent and AnalyticsSession — unique users, sessions, peaks and cohort retention' },
  { key: 'product-analytics',  label: 'Product Analytics',  group: 'INSIGHT',      readiness: 'LIVE',
    backing: 'AnalyticsEvent module and feature keys — deliberately separate from every audit table' },
