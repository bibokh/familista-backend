import { PrismaClient, UserRole, PlayerPosition, Foot, CompetitionType, MatchResult, InjurySeverity, DrillType, TransactionType, SubscriptionPlan, SubscriptionStatus, ScoutRecommendation } from '@prisma/client';
